...
using Xamarin.Forms;
using mdls = XamarinEvernote.Models;
using msgBus = XamarinEvernote.Staff.MessageBus;
using constMessageCenter = XamarinEvernote.Constants.ConstStrings.ClientMessageCenter;
